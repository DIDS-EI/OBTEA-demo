"""VirtualHome experiment - HARD goal.

Goal: stack the clothes on the bed, put the book on the desk and the condiment
shaker into the kitchen cabinet, then close the cabinet.

    python test_exp/main_VH_hard.py
"""
...
SCENE = "VH"
OUTPUT_NAME = "behavior_tree_vh_hard"
