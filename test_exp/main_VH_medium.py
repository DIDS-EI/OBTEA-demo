"""VirtualHome experiment - MEDIUM goal.

Goal: put chicken and pound cake into the stove, close it and switch it on.

    python test_exp/main_VH_medium.py
"""
...
SCENE = "VH"
OUTPUT_NAME = "behavior_tree_vh_medium"
